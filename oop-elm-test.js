...
var $author$project$OOP$Controller$evalOnlyObjects = function (model) {
	...
	if (parseRes.$ === 'Ok') {
		if (parseRes.a.$ === 'WithCT') {
			...
			console.log("Fwd " + (evalEnd - evalStart) + "ms");
			var objectVal = _v2.a;
			var state = _v2.b;
	...
	if (_v0.a.$ === 'Ok') {
		if (_v0.b.$ === 'Ok') {
			if (_v0.a.a.$ === 'WithCT') {
				...
				console.log("Bwd " + (unevalEnd - unevalStart) + "ms");
				var ctx_ = _v3.a;
				var term_ = _v3.b;
				...
				console.log("CTL " + (ctliftEnd - ctliftStart) + "ms");
				var liftedCT = _v5.a;
				var delList = _v5.b;
	...
	function (msg, model) {
		switch (msg.$) {
			case 'SaveCode':
				...
				console.log("F:Tot " + (evalCodeToModelEnd - evalCodeToModelStart) + "ms");
				return _Utils_Tuple2(
					newModel,
			...
			case 'Update':
				...
				console.log("B:Tot " + (updateEnd - updateStart) + "ms");
				return _Utils_Tuple2(
					newModel,
